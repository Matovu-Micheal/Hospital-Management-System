...
{    
  ...
  $sql = "INSERT INTO PATIENT (name,age,gender,nationality,tel,address,weight,p_uid)

  VALUES ('$name','$age','$gender','$nationality','$tel','$address','$weight','$UUID')";
  ...
  <div class="container-scroller">
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <div class="main-panel">        
        ...
        <div style="width:82%;" class="row m-5 mt-auto mb-auto">
                    ...
                    <div class="form-group">
                      ...
                      <div class="form-group">
                       ...
                       <div class="form-group mb-3">
                        ...
                        <input type="nationality" class="form-control" id="nationality" placeholder="Enter patient's Nationality" name="nationality">
                      </div>
