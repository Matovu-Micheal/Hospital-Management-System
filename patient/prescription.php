<?php require_once 'C:/xampp/htdocs/MUNI CLINIC/php/connection.php'; //connecting to db
                  ...
                  {    
                    $info="";
                      ...
                      $sql = "INSERT INTO prescription (`p_uid`,`date`,`drugs`,`dosage`)
                      VALUES ('$p_uid','$date','$drugs','$dosage')";

                      if (mysqli_query($conn, $sql)) {
                        $info = "<p class='text-success'>Patient's prescription has been added successfully !</p>";
                      } else {
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="navbar-brand-wrapper d-flex justify-content-center">
        ...
        <!-- <a class="navbar-brand " href="../../index.html">MUNI CLINIC</a> -->
      ...
      <div class="main-panel">        
        ...
        <div style="width:90%;" class="row">
          ...
          <div class="row">
            ...
            <!-- MY FORM -->
            <div style="width:60em;" class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <h4 class="mb-2">PATIENT'S PRESCRIPTION</h4>
                  ...
                  <div class="form-group mb-3">
                    ...
                    <input type="text" class="form-control" id="drugs"  name="drugs">
