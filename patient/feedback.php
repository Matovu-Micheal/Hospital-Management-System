          ...
          <div class="row row2">
            <div class="col-md-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  <div class='d-flex'>
                  <img src="../../images/icons8-comments-48.png">
                  <h4 class="mt-2">Feedback</h4>
                  </div>
                  <hr>
                  <form>
                  <div class='mt-4'>
                    <label>What would you recommend to us to improve our services?</label><br>
                    <textarea class='form-control' rows=6></textarea>
                  </div>
                  <div class='mt-3'>
                    <label>How would you recommend to do achiecve the stated above to improve our services?</label><br>
                    <textarea class='form-control' rows=6></textarea>
                  </div>
                  <div class='mt-3'>
