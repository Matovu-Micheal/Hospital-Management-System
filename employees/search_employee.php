      ...
      <div class="main-panel">        
        <div class="content-wrapper">
                    ...
                    <li class="nav-item nav-search d-none d-lg-block w-100">
                      <div class="input-group">
                        ...
                        <form method="post" style="width:100%;display: flex;">
                          ...
                          <button  type="submit" name="submit" class="btn btn-sm btn-primary"><i class="mdi mdi-magnify"></i></button>
                        </form>
          ...
          <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
              <div class="card-body">
                <h4 class="">Employee's Search Results</h4>
                          ...
                          while ($fetch = mysqli_fetch_array($result))
                            {
                              ...
                              $html .= "<td>" . $fetch['contact'] . "</td>";
                              $html .= "<td>" . $fetch['Next_of_kin'] . "</td>";
                              $html .= "<td>" . $fetch['role'] . "</td>";
                              
                             

                              $html .="<td>
                              <a href='edit-employee.php?select=". $fetch['e_id']."' class='select btn btn-sm rounded-0' 
