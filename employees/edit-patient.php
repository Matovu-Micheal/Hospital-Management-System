      ...
      <nav  class="sidebar  sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu" style="list-style:none;">
                <li class="nav-item"><a class="nav-link" href="pages/forms/add_drugs.php">ADD NEW DRUGS</a></li>
                <li class="nav-item"> <a class="nav-link" href="pages/forms/search_drugs.php">AVAILABE DRUGS</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu" style="list-style:none;">
                <li class="nav-item"><a class="nav-link" href="next_of_kin.php">EMPLOYEE NEXT OF KIN </a></li>
                <li class="nav-item"><a class="nav-link" href="patient_next_of_kin.php">PATIENT NEXT OF KIN </a></li>
                <li class="nav-item"> <a class="nav-link" href="next_of_kin_record.php">NEXT OF KIN RECORDS</a></li>
          ...
          <div class="row"> 
            ...
            <div style="width:90%;" class="col-12 grid-margin stretch-card">
              <div class="card ">
                ...
                <div  class="card-body">
                  <div class="ms-5"><h4>Patient Information</h4></div>
                  ...
                  <div class='col ms-4'>
                    ...
                    <ul style="font-size:1rem;" class="list-style-none list-unstyled">
                      ...
                      <li><span>Age:</span><span class="text-primary ms-2"><?php echo isset ($kin['age']) ? $kin['age'] : "No Information"; ?></span></li>
                      <li><span>Gender:</span><span class="text-primary ms-2 "><?php echo isset ($kin['gender']) ? $kin['gender']: "No Information" ; ?></span></li>
                      <span>Contact:</span><span class="text-primary ms-2"><?php echo isset ($kin['contact']) ? $kin['contact'] : "No Information"; ?></span></li>
                      <li><span>Address:</span><span class="text-primary ms-2"><?php echo isset ($kin['address']) ? $kin['address'] : "No Information"; ?></span></li>
                      <li><span>Relationship:</span><span class="text-primary ms-2"><?php echo isset ($kin['relationship']) ? $kin['relationship']: "No Information"; ?></span></li>
                    </ul>
                  </div>
                  </div>
