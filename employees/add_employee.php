...
{    
    ...
    GLOBAL $UUID;
    $UUID= uniqid ('E_',true); // unique id generating function
    $nk_id=$UUID;
    if (isset($_FILES['uploadfile'])):
      ...
      $sql = "INSERT INTO employee (e_id,name,picture,age,gender,contact,role)
    VALUES ('$nk_id','$name','$picture','$age','$gender','$contact','$role')";

    if (mysqli_query($conn, $sql)) {
      $info = "<p class='text-success'>A new Employee $name has been added successfully !</p>";
      header("Location: patient_next_of_kin.php");
    } else {
      $info = "Error: " . $sql . ":-" . mysqli_error($conn);
        if (!is_numeric($age)){
          $info = "<p class='text-danger'>Age must be an integer</p>";
        }else{
          $info = "<p class='text-danger'>Fill in the correct employees information!</p>";
        }
      ...
      <nav  class="sidebar  sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu" style="list-style:none;">
                <li class="nav-item"><a class="nav-link" href="../../pages/admin/add_patient.php">ADD PATIENT</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/admin/search_patient.php">CHECK PATIENT</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/admin/medical_records.php">MEDICAL RECORD</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../pages/admin/appointments.php">CREATE APPOINTMENT</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/admin/appointments_records.php">CHECK APPOINTMENT LIST</a></li>
              </ul>
            </div>
          </li> 
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item"> <a class="nav-link" href="../../pages/admin/user_accounts.php">CREATE USER ACCOUNT</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/admin/account_edit.php">EDIT USER ACCOUNT</a></li>
              </ul>
            </div>
          </li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu" style="list-style:none;">
                <li class="nav-item"><a class="nav-link" href="../../pages/admin/diagnosis.php">DIAGNOSIS</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/admin/prescription.php">PRESCRIPTION</a></li>
              </ul>
            </div>
          </li>
          ...
          <!-- PHARMARCY -->
           ...
           <li class="nav-item">
            <a class="nav-link" data-bs-toggle="collapse" href="#ui-basic" aria-expanded="false" aria-controls="ui-basic">
              <img class="icons" src="../../images/icons8-medicine-32.png">
              <span class="menu-title">PHARMARCY</span>
              <i class="menu-arrow  "></i>
            </a>
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu" style="list-style:none;">
                <li class="nav-item"><a class="nav-link" href="../../pages/admin/add_drugs.php">ADD NEW DRUGS</a></li>
                <li class="nav-item"> <a class="nav-link" href="../../pages/admin/search_drugs.php">AVAILABE DRUGS</a></li>
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu" style="list-style:none;">
                <li class="nav-item"><a class="nav-link" href="../../pages/admin/labresullts.php">LAB RESULTS</a></li>
            ...
            <div class="col-md-12 grid-margin">
              <div class="d-flex justify-content-between flex-wrap">
                ...
                <div class="d-flex justify-content-between align-items-end flex-wrap">
                  ...
                  <a href="search_employee.php" class="btn btn-primary mt-2 mt-xl-0">CHECK EMPLOYEE</a>
                </div>
              </div>
            </div>
          </div>
                ...
                <div  class="card-body">
                  ...
                  <form id='personal' style="width:90%;" method="POST"  class="mb-4 mt-2" enctype="multipart/form-data">
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="text" class="form-control" id="name" name="name" placeholder="Enter Users" required>
                    </div>
                    ...
                    <div class="form-group mb-3">
                      ...
                      <input type="text" class="form-control" id="roles" required name="roles">
                    </div>
                    <div class="form-group mb-3">
