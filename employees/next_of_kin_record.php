                    ...
                    <table id="recent-purchases-listing" class="data table  table-bordered">
                      ...
                      if (mysqli_num_rows($result) > 0){
                        ...
                        while ($fetch = mysqli_fetch_array($result))
                          {
                            $html .= "<tr>";
                            if (!empty($fetch['e_nkid']) && !($fetch['e_nkid'])==NULL){
                              $html .= "<td>" . $fetch['e_nkid'] . "</td>";
                            }else{
                              $html .= "<td>" . $fetch['nk_id'] . "</td>";
                            }
                             
                            $html .= "<td>" . $fetch['fname'].' '.$fetch['lname']  . "</td>";  
                            $html .= "<td>" . $fetch['age'] . "</td>";
                            $html .= "<td>" . $fetch['contact'] . "</td>";
                            $html .= "<td>" . $fetch['gender'] . "</td>";
                            $html .= "<td>" . $fetch['address'] . "</td>";
                           
                            $html .= "<td>" . $fetch['relationship'] . "</td>";
                            
                            
                            $html .="<td>
                            <a href='nk-record.php?record=".$fetch['id']."' class='' 
