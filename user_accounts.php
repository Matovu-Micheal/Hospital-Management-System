<?php require_once 'C:/xampp/htdocs/MUNI CLINIC/php/connection.php'; //connecting to db
            ...
            {   
                ...
                $sql = "INSERT INTO USERACCOUNT (username,password,profile,e_id)
                VALUES ('$name','$password','$picture','$e_id')";
      ...
      <nav style="font-family:raleway,'Roboto', sans-serif; font: weight 500px;" class="sidebar  sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            ...
            <div class="collapse" id="">
              <ul class="nav flex-column sub-menu">
              <li class="nav-item"> <a class="nav-link" href="admin_accounts.php">ADMIN ACCOUNT</a></li>
